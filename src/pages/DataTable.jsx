...
const DataTable = ({
  ...
  const columns1 = [
    ...
    {
      field: "Potentinal_Polio_Hits",
      headerName: "Potentinal Polio Hits",
      headerAlign: "left",
      type: "string",
      width: "136",
      fontSize: "5rem",
    ...
    {
      field: "Conting_Assembly",
      headerName: "Conting Assembly",
      width: "136",
      editable: true,
      type: "string",
      align: "left",
